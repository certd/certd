export default {
  sys: {
    setting: {
      ...
      customAcmeName: "名称",
      customAcmeSslProvider: "标识(sslProvider)",
      customAcmeSslProviderHelper: "唯一标识，如 myca；创建流水线和ACME账号时用它来区分颁发机构",
      customAcmeReverseProxy: "反向代理地址",
      customAcmeReverseProxyHelper: "选填；ACME端点无法直连时的反代地址，不带http://",
