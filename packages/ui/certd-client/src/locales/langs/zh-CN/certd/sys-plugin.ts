export default {
  ...
  pluginDependenciesHelper: "从已同步的插件市场或内置插件中选择依赖插件（默认任意版本）",
  ...
  onlinePluginUpgradeAll: "升级全部插件",
  onlinePluginNoUpgradeAvailable: "没有可升级的插件",
  onlinePluginUpgradeAllSuccess: "已成功升级 {count} 个插件",
  onlinePluginUpgradeAllPartialFailure: "已升级 {successCount} 个插件，升级失败：{failedNames}",
  ...
  onlinePluginDependenciesTitle: "检测到插件依赖",
  onlinePluginDependenciesPrompt: "安装此插件前，需要先安装以下依赖插件：",
  onlinePluginInstallDependencies: "一键安装依赖",
  onlinePluginDependencyNotFound: "依赖插件未同步",
  onlinePluginDependencyCycle: "插件依赖存在循环：{name}",
