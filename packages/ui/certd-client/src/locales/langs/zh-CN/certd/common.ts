export default {
  ...
  accountInit: {
    title: "绑定邮箱",
    description: "为保证用户体验，请先绑定邮箱，初始化您的账号",
    email: "邮箱",
    ...
    emailConfirm: "确认邮箱",
    emailConfirmPlaceholder: "请再次输入邮箱地址",
    emailConfirmHelper: "请再次输入邮箱，以确认邮箱地址无误",
    emailConfirmRequired: "请再次输入邮箱地址",
    emailMismatch: "两次输入的邮箱地址不一致",
    success: "邮箱绑定成功",
  },
  pluginCommon: {
    test: "测试",
