export default {
  dashboard: {
    ...
    totalGeneratedCertCount: "Total Certificates Generated",
    singleDomainCertShortCount: "Single-domain",
    multiDomainCertShortCount: "Multi-domain",
    wildcardCertShortCount: "Wildcard",
