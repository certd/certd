export default {
  ...
  accountInit: {
    title: "Bind Email",
    description: "Please bind an email address to initialize your account.",
    email: "Email",
    emailPlaceholder: "Please enter an email address",
    emailHelper: "Please enter your email address",
    emailRequired: "Please enter an email address",
    emailInvalid: "Please enter a valid email address",
    emailConfirm: "Confirm Email",
    emailConfirmPlaceholder: "Please enter the email address again",
    emailConfirmHelper: "Please enter the email address again to confirm it is correct",
    emailConfirmRequired: "Please enter the email address again",
    emailMismatch: "The two email addresses do not match",
