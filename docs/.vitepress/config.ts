        ...
        sidebar: {
            "/guide/": [
                ...
                },
                {
                    text: '特性',
                    items: [
                        {text: 'CNAME代理校验', link: '/guide/feature/cname/'},
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {text: '腾讯云', link: '/guide/use/tencent/tencent'},
                        {text: '连接windows主机', link: '/guide/use/host/host'},
                        {text: 'google EAB', link: '/guide/use/google/google'},
                ...
                },
                {
                    text: '其他',
                    items: [
                        {text: '镜像说明', link: '/guide/image'},
                        {text: '更新日志', link: '/guide/changelogs/CHANGELOG'},
                    ]
                },
            ],
        },
